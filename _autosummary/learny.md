...
: A per-student learner model whose priors update from that student’s own
  data. Start with [`LearnerModel`](learny.tracing.model.md#learny.tracing.model.LearnerModel).
...
| [`tracing`](learny.tracing.md#module-learny.tracing)   | Learner modelling: what a student knows, estimated from what they have answered.   |
|----------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
